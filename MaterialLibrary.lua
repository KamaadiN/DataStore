    ...
    function Material.Load(Config)
        ...
        local Title = Config.Title or "Material"
        ...
        local TitlePadding = Objects.new("UIPadding")
        TitlePadding.PaddingLeft = UDim.new(0,7.5)
        TitlePadding.Parent = TitleText
        
        local SubTitleText = Objects.new("Button")
        SubTitleText.Name = "SubTitle"
        SubTitleText.Text = SubTitle
        SubTitleText.TextColor3 = Theme.TitleBarAccent
        ...
        SubTitleText.MouseButton1Down:Connect(function()
        ...
        TweenService:Create(SubTitleText, TweenInfo.new(1), {TextTransparency = 0}):Play()
        ...
        function TabLibrary.New(TabConfig)
            ...
            if ImageID then
                ...
                Button.Font = Settings.Font
                Button.Text = Title:upper()
                Button.Size = UDim2.fromScale(0,1) + UDim2.fromOffset(TextSize+15)
                Button.ZIndex = 200
                Button.TextTransparency = (TabCount == 0 and 0) or 0.5
            end
            ...
            function OptionLibrary.Button(ButtonConfig)
                ...
                NewButton.Size = UDim2.fromScale(1,0) + UDim2.fromOffset(0,30)
            ...
            function OptionLibrary.Dropdown(DropdownConfig)
                ...
                Dropdown.Size = UDim2.fromScale(1,0) + UDim2.fromOffset(0,25)
                Dropdown.Parent = PageContentFrame

                local DropdownBar = Objects.new("Round")
                DropdownBar.Name = "TitleBar"
                DropdownBar.Size = UDim2.fromScale(1,0) + UDim2.fromOffset(0,25)
                ...
                DropdownButton.Image = "rbxassetid://11562688110"
                DropdownButton.ScaleType = Enum.ScaleType.Stretch
                DropdownButton.Size = UDim2.fromScale(0.9, 0.9) - UDim2.fromOffset(4,4)
                DropdownButton.Position = UDim2.fromOffset(-5, 3)
                ...
                DropdownContent.Position = UDim2.fromOffset(0,30)
                ...
                table.foreach(DropdownOptions, function(_, Value)
                    local NewButton, Label = CreateNewButton({
                        Text = Value,
                ...
                DropdownTitle.MouseButton1Down:Connect(function()
                    ...
                    TweenService:Create(DropdownButton, TweenInfo.new(0.15), {Rotation = DropToggle and 90 or 0}):Play()
                    TweenService:Create(DropdownContent, TweenInfo.new(0.15), {Size = DropToggle and DropdownSize or UDim2.fromScale(1,0)}):Play()
                    TweenService:Create(Dropdown, TweenInfo.new(0.15), {Size = DropToggle and (DropdownSize + UDim2.fromOffset(0, 30)) or (UDim2.fromScale(1,0) + UDim2.fromOffset(0, 25))}):Play()
                end)
            ...
            function OptionLibrary.Toggle(ToggleConfig)
                ...
                local StartWithCallback = ToggleConfig.StartWithCallback or true
            ...
            function OptionLibrary.Slider(SliderConfig)
                ...
                SliderTitle.Position = UDim2.fromOffset(7.5, 3)
                ...
                SliderValue.Position = UDim2.fromOffset(-10, 3)
